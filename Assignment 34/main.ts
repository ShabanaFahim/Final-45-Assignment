...
/* Pizzas: Think of at least three kinds of your favorite pizza. Store these pizza names in a array,
  and then use a for loop to print the name of each pizza • Modify your for loop to print a sentence using the name of the pizza instead of printing just the 
...
*/
 ...
 let Pizzas :string[] = ["pepperoni" , "cheese" , "Chicken Fajeeta"];

// for loop to print a sentence using the name of the pizza
Pizzas.forEach(pizza => {
    console.log(`I like ${pizza} pizza.`)
});
//printing the message for how much you like pizza
